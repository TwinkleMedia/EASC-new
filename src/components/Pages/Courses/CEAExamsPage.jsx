...
const CEAExamsPage = () => {
  ...
  const navigate = useNavigate(); // Added for redirecting to cart page
    ...
    const fetchCourses = async () => {
      try {
        ...
        if (Array.isArray(data)) {
          ...
          ceaCourses = data.filter(course => 
            (course.title && course.title.toLowerCase().includes("cea")) || 
            (course.subject && course.subject.toLowerCase().includes("cea")) ||
            (course.paper && course.paper.includes("2"))
          );
        } else if (data && data.courses && Array.isArray(data.courses)) {
          // If data has a courses property that is an array
          ceaCourses = data.courses.filter(course => 
            (course.title && course.title.toLowerCase().includes("cea")) || 
            (course.subject && course.subject.toLowerCase().includes("cea")) ||
            (course.paper && course.paper.includes("2"))
          );
          ...
          ceaCourses = Array.isArray(data) ? data : [];
        }

        console.log("Fetched courses:", ceaCourses);
        
        // Process courses to ensure they have all necessary properties
        const processedCourses = ceaCourses.map(course => {
  ...
  const defaultLearningOutcomes = [
    "Energy auditing methodologies and procedures",
    "Building energy assessment techniques",
    "Industrial systems efficiency analysis",
    "Economic evaluation of energy conservation measures",
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-700">
                    No CEA courses found. Please check back later or contact support.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="md:w-1/3 bg-gray-50 p-6 border-r border-gray-200">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="font-semibold text-gray-800">{selectedCourse.subject || "CEA"}</p>
                    </div>
                  ...
                  <div className="py-2">
                    ...
                    {activeTab === "description" && (
                      <div>
                        ...
                        <p className="text-gray-700 leading-relaxed">
                          {selectedCourse.description || "This comprehensive course provides all the materials and guidance you need to excel in your CEA certification exam, focusing on essential energy auditing principles and methodologies."}
                        </p>
                        ...
                        <div className="mt-8">
                          ...
                          <ul className="space-y-2">
                            <li className="flex items-start">
                              ...
                              <span>Energy auditors seeking certification</span>
                            </li>
                            <li className="flex items-start">
                              <ChevronRight size={18} className="text-emerald-500 mt-0.5 mr-2 flex-shrink-0" />
                              <span>Building performance professionals</span>
                            </li>
                            <li className="flex items-start">
                              <ChevronRight size={18} className="text-emerald-500 mt-0.5 mr-2 flex-shrink-0" />
                              <span>Energy assessment specialists</span>
                            </li>
                            <li className="flex items-start">
                              <ChevronRight size={18} className="text-emerald-500 mt-0.5 mr-2 flex-shrink-0" />
                              <span>Professionals working in energy efficiency implementation</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    {activeTab === "materials" && (
                      <div>
                        ...
                        <p className="text-gray-700 mb-6">
                          Access comprehensive study materials designed to help you master all required concepts for the {selectedCourse.paper || "CEA"} examination.
                        </p>
                    ...
                    {activeTab === "learning" && (
                      <div>
                        ...
                        <p className="text-gray-700 mb-6">
                          By the end of this course, you'll have mastered these key concepts and skills necessary for the {selectedCourse.paper || "CEA"} examination:
                        </p>
    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl hover:translate-y-px flex flex-col h-full">
      ...
      <div className="relative">
        ...
        <div className="absolute top-4 left-4 px-3 py-1 bg-white rounded-full shadow-md">
          <span className="font-medium text-emerald-700 text-sm">{course.paper || "CEA"}</span>
        </div>
        ...
        <p className="text-gray-600 mb-6 flex-grow">
          {course.description 
            ? (course.description.length > 100 
                ...
                : course.description)
            : "Comprehensive preparation for CEA certification exams..."}
        </p>
