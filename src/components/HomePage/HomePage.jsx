...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              ...
              <p className="text-gray-600 mb-6">
                ...
                {/* At EASC, we provide industry-leading training programs for energy auditors, sustainability consultants, and facilities managers. 
                Our comprehensive courses combine theoretical knowledge with practical applications to ensure our students are well-prepared 
              ...
              <p className="text-gray-600 mb-8">
                ...
                {/* Founded by experienced professionals with decades of industry experience, 
                our center focuses on up-to-date methodologies, tools, and best practices 
                that align with international standards and certifications. */}
              </p>
      ...
      {/* Featured Courses Preview Section (Optional) */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-white rounded-xl shadow-md overflow-hidden transition-transform hover:shadow-lg hover:-translate-y-1">
                <div className="h-48 bg-gradient-to-r from-emerald-600 to-emerald-400 flex items-center justify-center">
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Link to="/courses" className="text-emerald-600 font-medium flex items-center">
